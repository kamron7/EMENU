...
import { createHooks } from "G:/EMENU/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "G:/EMENU/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "G:/EMENU/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "G:/EMENU/node_modules/radix3/dist/index.mjs";
import { defu } from "G:/EMENU/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "G:/EMENU/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CiMMT_-S.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Cbu2_5qX.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BEtlPQJH.js"));
